...
def db_seed():
    ...
    memory_1 = Memory(image='https://merriam-webster.com/assets/mw/images/article/art-wap-landing-mp-lg/family-of-four-7101-a234e9249b2c7223d4e4d8cd9432f9e9@1x.jpg', song='https://open.spotify.com/track/5IKLwqBQG6KU6MP2zP80Nu?si=OTIOYPYbRV-10u_9xKKOiw', description='Fresh herbs growing', aromas='Basil, mint, thyme', x = 677, y = 785, room_id=room_1.id)
    memory_2 = Memory(image='https://d1urgxgdb4lky3.cloudfront.net/wp-content/uploads/2020/05/191115-Cookie-Jar-Jennifer-SC-022copy.jpg', song='https://open.spotify.com/track/0bYg9bo50gSsH3LtXe2SQn?si=Srv8kAEbSuCa6iFGsGbKIA', description='Such great times', aromas='Fresh baked cookies', x = 209, y = 379, room_id=room_1.id)
    memory_3 = Memory(image='https://d1urgxgdb4lky3.cloudfront.net/wp-content/uploads/2020/05/191115-Cookie-Jar-Jennifer-SC-022copy.jpg', song='https://open.spotify.com/track/0bYg9bo50gSsH3LtXe2SQn?si=Srv8kAEbSuCa6iFGsGbKIA', description='Learning to bake', aromas='Burnt cupcakes', x = 500, y = 550, room_id=room_1.id)
