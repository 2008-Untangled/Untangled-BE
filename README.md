...
| Get Memories |`/rooms/:id/memories`| GET | | <pre> {<br>   "data": {<br>     "memories": [<br>       {<br>        id: `<int>`,<br>        description: `<string>`,<br>        image: `<string>`,<br>        song: `<string>`,<br>        aromas: `<str>`,<br>        x: `<int>`,<br>       y: `<int>`<br>   },<br>        {<br>        id: `<int>`,<br>        description: `<string>`,<br>        image: `<string>`,<br>        song: `<string>`,<br>        aromas: `<str>`,<br>        location: `<string>`,<br>        },<br>        ]<br>    }<br>} </pre> |